        ...
        <div className="flex flex-col gap-3">
          {hint && (
            <div>
              ...
              {showHint && (
                <div className="mt-2 p-3 bg-secondary-container border-2 border-brand-dark rounded-neo-sm italic text-sm text-brand-dark">
          ...
          {showExplanation && (
            <div className="mt-4 p-4 bg-green-50 border-3 border-green-800 rounded-neo animate-in fade-in slide-in-from-top-2">
              <div className="flex items-start gap-2">
                <CheckCircle2 className="w-5 h-5 text-green-800 mt-0.5 shrink-0" />
...
const components: PortableTextComponents = {
  ...
  block: {
    normal: ({ children }) => {
      ...
      if (match) {
        return (
          <div className="my-4 border-3 border-brand-dark/10 rounded-neo-sm overflow-hidden bg-white hover:border-brand-dark/30 transition-colors">
